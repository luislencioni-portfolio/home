...
(function($) {
	...
	document.addEventListener('DOMContentLoaded', () => {				
		...
		document.querySelector('a[href="#wrapper"]').addEventListener('click', function(event) {
			event.preventDefault();
		...
		document.addEventListener('DOMContentLoaded', () => {
			...
			// Show the modal and overlay, and disable scrolling
			modal.style.display = 'block';
			overlay.style.display = 'block';
			body.classList.add('no-scroll'); // Disable scrolling

			// Prevent scrolling with JavaScript (for extra security)
